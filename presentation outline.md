...
- For each slide, propose at least one visualization and include:
  - Visual type: chart/diagram/layout/iconography
  - Layout hint: where the visual goes (e.g., left side, top third, full-width) and where the text goes
  - Focus: what should stand out (e.g., one key metric, a ‘before vs after’ comparison)
  - Style hint: simple color or style suggestion (e.g., ‘use a muted palette with one accent color’).
  - Keep hints concise and practical for use in PowerPoint/Keynote/Google Slides
